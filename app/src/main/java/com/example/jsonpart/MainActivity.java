...
public class MainActivity extends AppCompatActivity {
    ...
    private class pictures extends AsyncTask<Object, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Object[] objects) {
            try {
                ...
                for(int i=0; i< 30; i++){
                    ...
                    pic = Bitmap.createScaledBitmap(pic, 610, 600, true);
                    pictures.add(pic);
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            badAdapter = new myAdapter(getApplicationContext(), R.layout.activity_each_row, pictures);
            badCharactersListView = findViewById(R.id.all);
